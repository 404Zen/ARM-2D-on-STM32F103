...
{
    DEV_Digital_Write(EPD_RST_PORT, EPD_RST_PIN, 1);
    DEV_Delay_ms(100);
    DEV_Digital_Write(EPD_RST_PORT, EPD_RST_PIN, 0);
    DEV_Delay_ms(100);
    DEV_Digital_Write(EPD_RST_PORT, EPD_RST_PIN, 1);
    DEV_Delay_ms(100);
}
...
static void LCD_1IN3_SendCommand(UBYTE Reg)
{
    ...
    DEV_Digital_Write(EPD_CS_PORT, EPD_CS_PIN, 0);
...
{
    DEV_Digital_Write(EPD_DC_PORT, EPD_DC_PIN, 1);
    DEV_Digital_Write(EPD_CS_PORT, EPD_CS_PIN, 0);
...
static void LCD_1IN3_InitReg(void)
{
    ...
    LCD_1IN3_SendCommand(0xB0);     /* 修改RGB排列方式 */
    LCD_1IN3_SendData_8Bit(0x00);
